...
class gThemeFeed extends gThemeModuleCore 
{
	...
	function the_content_feed( $content, $feed_type )
	{
		global $id;
		...
		if ( count( $replaces ) ) {
			...
			if ( $external ) {
				...
				$footer .= '<hr /><p style="margin-left:auto;margin-right:auto;text-align:center;direction:rtl;font:bold 1.3em arial;"><a style="text-decoration:none;color:#ccc;" href="'.$external.'">„Ã„Ê⁄Â ò«„·  ’«ÊÌ— —« œ— «Ì‰ùÃ« »»Ì‰œ</a></p>';
			} else {
				...
				$footer .= '<hr /><p style="direction:rtl;font:bold 1.3em arial;">'
						.'<a style="text-decoration:none;color:#ccc;" href="'.get_permalink( $id ).'/#respond">œÌœê«Â ‘„«</a> / '
						.'<a style="text-decoration:none;color:#ccc;" href="'.get_option( 'home' ).'/?p='.$id.'">ÅÌÊ‰œ òÊ «Â</a></p>';
			}		
			**/
	...
	function the_content_feed_restricted( $content, $feed_type )
	{
