...
<script src="//static.addtoany.com/menu/page.js"></script><?php
	...
	public static function image( ?string $context = NULL, null|false|string $link = NULL, ?string $tag = NULL ): void
	{
		do_action( 'gtheme_content_image_wrap_before', $context, $link, $tag );
		...
		do_action( 'gtheme_content_image_wrap_after', $context, $link, $tag );
	}
